export const REQUIRED_ERROR_MESSAGE = 'Please provide your';
export const SOMETHING_WENT_WRONG = 'Something went wrong';

export const NO_MORE = 'No more data at the moment';
export const NO_JOB = 'No job yet!!';
export const NO_CHAT = 'No chat yet!!';
