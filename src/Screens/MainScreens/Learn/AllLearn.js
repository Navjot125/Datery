...
import { LearnAllDetailsRequest, LearnAllRequest } from "../../../modules/learn/actions";
...
const AllLearn = (props) => {
  ...
  const showList = ({ item }) => {
    ...
    const splittedStr = item?.file?.length ? String(item?.file[0]).split('.') : ""
    ...
    return (
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          navigation.navigate(item.category == 'Coach' ? 'CoachDetail' : !isVideo ? 'AdviceDetail' : 'CourseOverview', {
            item
          })
        }}
            ...
            {item?.category !== "Coach" ? (
              <View style={[styles.card]}>
                <View style={{ height: 120, width: 120 }}>
                  <Image
                    source={!isVideo ? { uri: `http://54.92.82.16:3001/data/${item?.file}` } : { uri: `http://54.92.82.16:3001/data/${item?.thumbnailFile}` }}
                ...
                <View style={{
                  ...
                  <Text style={[styles.textBetween, { marginTop: 2 }]}> {item.coachName}</Text>
              ...
              <View style={[styles.card]}>
                ...
                <View style={{
                  ...
                  <Text style={[styles.textBetween, {}]}> {item.coachAddress}</Text>
                  <Text style={[styles.textBetween, {}]}> {item.coachApproach}</Text>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  LearnAllRequest: (data, navigation) => dispatch(LearnAllRequest(data, navigation)),
