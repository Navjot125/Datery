...
const PlanReserved = (props) => {
  ...
  const [modalVisibleAvailablity, setModalVisibleAvailablity] = React.useState(
    props?.state?.roleReducer?.role?.id == 1 ? true : false
  );
  ...
  const [monthName2, setMonthName2] = React.useState(
      ...
      <View style={[styles.cardView]}>
        ...
        >
          ...
          >
            <Image
              source={{
                uri: `http://54.92.82.16:3001/data/${item?.records[0].providerImage}`,
              }}
              style={{
                height: 95,
                width: 110,
            ...
            <View style={{ flex: 1, marginHorizontal: 10 }}>
              ...
              >
                <Text style={styles.mediaType2}>
                  ...
                  {"    "}
                  {/* {"Availability"} */}
                  {item.date ? item.date : "Buy Now,Book Later"}{" "}
                  {item.records[0].time ? item.records[0].time : ""}
                </Text>
              </TouchableOpacity>
              {/* </View> */}
            </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Text
            style={[
              styles.textStyle,
              { color: color._primary_orange, marginTop: 10 },
            ]}
          >
            Book a Date
          </Text>
  ...
  const arrayToObj = () => {
    ...
    Object.keys(plan).map((month) => {
      plan[month].map((item) => {
        ...
        arr.push([
          moment(item.records[0].date).format("YYYY-MM-DD"),
          selectDateObj,
        ]);
      });
    });
    arr.push([
      ...
      { selected: true, selectedColor: color._primary_orange, id: "" },
    ]);
        ...
        <View style={styles.mainView}>
          ...
          >
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => {
                navigation.navigate("PlanReadyReservation");
              }}
            >
              <Image
                source={require("../../../assets/images/PlanReady.png")}
                style={{
                  height: 22,
                  width: 22,
