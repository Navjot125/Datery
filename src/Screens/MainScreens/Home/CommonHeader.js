  ...
  const search = () => {
    let loc =
      role == 1
        ? tempName
          ? tempName
          : props.geoCityShortName
          ? props.geoCityName?.length > 10
            ? props.geoCityShortName
            : props.geoCityName
          : ""
        : tempName
    ...
    return (
      ...
      >
        <Searchbar
          onTouchEnd={() =>
            navigation.navigate("HomeSearchResult", { setText: props.setText })
          }
          // disable={true}
          // editable={false}
          showDivider={false}
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            // }
            // role == 2 ?
            //     props.state.cartReducer?.cartCount == null ? setEmptyCart(true)
