...
import { CardAllDetailsRequest, CardAllRequest, CardfavouriteListRequest } from "../../../modules/addCard/actions";
...
const AddCard = (props) => {
  ...
  const handlePayment = () => {
    try {
      ...
      dispatch(CardAllRequest({ data, callback, token, endpoint: API_URL.addCard, }))
      setCardDetails({
        name: "",
        cardNumber: '',
        expiryMonth: '',
        ...
        {loader ? <ActivityIndicator color={color._primary_orange} size={'large'} /> :
          (
            <ScrollView
              ...
              style={{ marginTop: 20 }} showsVerticalScrollIndicator={false}>
              ...
              <Atom.CheckBox
                ...
                onPress={() => setCardDetails({ ...cardDetails, default: !cardDetails.default })}
