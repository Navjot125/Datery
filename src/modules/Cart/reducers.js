import { ADD_TO_CART_REQUESTED, ADD_TO_CART_SUCCESS, ADD_TO_CART_FAIL, CART_LIST_REQUESTED, CART_LIST_SUCCESS, CART_LIST_FAIL, ADD_TO_CART_GUEST_REQUESTED, ADD_TO_CART_GUEST_SUCCESS, ADD_TO_CART_GUEST_FAIL, REMOVE_ITEM_FROM_CART_REQUESTED, REMOVE_ITEM_FROM_CART_SUCCESS, REMOVE_ITEM_FROM_CART_FAIL, REMOVE_ITEM_FROM_GUEST_CART_REQUESTED, REMOVE_ITEM_FROM_GUEST_CART_SUCCESS, REMOVE_ITEM_FROM_GUEST_CART_FAIL, REMOVE_ALL } from './types';
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case REMOVE_ITEM_FROM_CART_SUCCESS:
      return {
        ...state,
        cartListUser: state.cartListUser.filter((item) => item._id !== action.data?.cartId?.cartId),
