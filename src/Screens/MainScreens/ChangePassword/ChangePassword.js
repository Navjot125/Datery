  ...
  return (
    <SafeAreaView style={styles.scrollView}>
      ...
      <View style={{
        ...
        <Formik
          ...
          onSubmit={values => {
            ...
            props.changePasswordRequest({currentPassword: values.currentPassword, newPassword: values.newPassword }, params);
          }}
        >
          {({
            handleChange,
            ...
            <>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Atom.TextInputSimple
                  ...
                  value={values.currentPassword} typePassword={true} />
      ...
      <Model.CommonPopUp
        ...
        onPress={() => { setModalVisibleAvailablity(false), navigation.navigate("Profile") }}
      />
      <Model.CommonPopUp
...
const mapDispatchToProps = (dispatch) => ({
  changePasswordRequest : (data, navigation) => dispatch(changePasswordRequest(data, navigation))
});
