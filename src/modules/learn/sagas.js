...
import { FAVOURITELIST_REQUESTED, FAVOURITE_REQUESTED, LEARNALLDETAILS_REQUESTED, LEARNALL_REQUESTED, LEARNFAVOURITELIST_REQUESTED, LEARNFAVOURITE_REQUESTED, LEARN_REMOVE_FAVOURITE_REQUESTED, MERCHANTDETAILS_REQUESTED, MERCHANT_REQUESTED, REMOVE_FAVOURITE_REQUESTED, } from './types';
import { merchantSuccess, merchantFail, merchantDetailsSuccess, merchantDetailsFail, favouriteListFail, favouriteListSuccess, removeFavouriteSuccess, removeFavouriteFail, LearnAllFail, LearnAllSuccess, LearnAllDetailsSuccess, LearnAllDetailsFail, LearnfavouriteListSuccess, LearnfavouriteListFail, LearnremoveFavouriteFail, LearnremoveFavouriteSuccess } from './actions';
...
function* sagaLearn() {
  ...
  yield takeLatest(LEARN_REMOVE_FAVOURITE_REQUESTED, onLearnRemoveFavouriteRequest);
}
